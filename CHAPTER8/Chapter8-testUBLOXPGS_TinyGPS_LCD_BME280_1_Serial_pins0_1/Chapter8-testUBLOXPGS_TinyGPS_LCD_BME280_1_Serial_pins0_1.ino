// Chapter8-testUBLOXPGS_TinyGPS_LCD_BME280_1_Serial_pins0&1.ino
#include <TinyGPS.h>
...
void setup() {
mySerial.begin(9600); // GPS SERIAL COMMUNICATION THROUGH DEFINED PINS 
                    // GPS TX --> ARDUINO PIN 5 (RX)
                    // GPS RX --> ARDUINO PIN 4 (TX) 
